CREATE DATABASE IF NOT EXISTS `resume_power_station`
  DEFAULT CHARACTER SET utf8mb4
  DEFAULT COLLATE utf8mb4_unicode_ci;

USE `resume_power_station`;
...
CREATE TABLE `OptimizedVersion` (
    ...
    INDEX `OptimizedVersion_resumeId_createdAt_idx`(`resumeId`, `createdAt`),
    INDEX `OptimizedVersion_deletedAt_idx`(`deletedAt`),
    INDEX `OptimizedVersion_restoredFromVersionId_idx`(`restoredFromVersionId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE `DailyUsage`
  ADD CONSTRAINT `DailyUsage_anonymousSessionId_fkey`
...
ALTER TABLE `OptimizedVersion`
  ADD CONSTRAINT `OptimizedVersion_resumeId_fkey`
  FOREIGN KEY (`resumeId`) REFERENCES `Resume`(`id`)
  ON DELETE RESTRICT ON UPDATE CASCADE;
